...
latex_documents = [
  ('index', 'Workflow.tex', u'Workflow Documentation',
   u'Roman Chyla', 'manual'),
]
...
man_pages = [
    ('index', 'workflow', u'Workflow Documentation',
     [u'Roman Chyla'], 1)
]
...
texinfo_documents = [
  ('index', 'Workflow', u'Workflow Documentation',
   u'Roman Chyla', 'Workflow', 'One line description of project.',
   'Miscellaneous'),
]
